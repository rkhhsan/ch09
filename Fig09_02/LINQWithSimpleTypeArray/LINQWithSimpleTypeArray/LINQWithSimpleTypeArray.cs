...
class LINQWithSimpleTypeArray
{
   public static void Main( string[] args )
   {
      ...
      // LINQ query that obtains values equal or greater than 4 from the array
      var filtered =
         from value in values
         where value >= 4
         select value;
      // display filtered results
      Console.Write( "\nArray values equal or greater than 4:" );
      ...
      Console.Write("\nValues equal or greater than 4, descending order (separately):" );
      ...
      // filter original array and sort results in ascending order
      var sortAndFilter2 =
         from value in values
         where value >= 4
      ...
      // display the filtered and sorted results
      Console.Write(
         "\nValues greater than 4, ascsnding order (one query):");
      foreach (var element in sortAndFilter2)
         Console.Write(" {0}", element);
